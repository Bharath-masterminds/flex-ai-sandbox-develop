"""
Configuration class for OpsResolve IoC container settings.
"""

import os


class OpsResolveIocConfig:
    """
    Configuration class for OpsResolve Inversion of Control (IoC) container settings.
